...
@Component({
  ...
  styleUrls: ['./add-sous-categorie.component.scss'],
})
export class AddSousCategorieComponent  implements OnInit,OnDestroy {
  ...
  constructor(private categorieService:CategorieService,private activatedRoute:ActivatedRoute,private router: Router,private selectMediaSerice:SelectMediaService,private modalMessageService:AlertMessageService) { 
  ...
  handleFileInput(event: any){
   ...
   Valider(){
    ...
    this.categorieService.addSousCategorie(formData).subscribe(
      res=>{
