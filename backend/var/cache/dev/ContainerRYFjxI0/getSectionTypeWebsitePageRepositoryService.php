 ...
 */
class getSectionTypeWebsitePageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SectionTypeWebsitePageRepository' shared autowired service.
     *
     * @return \App\Repository\SectionTypeWebsitePageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SectionTypeWebsitePageRepository.php';

        return $container->privates['App\\Repository\\SectionTypeWebsitePageRepository'] = new \App\Repository\SectionTypeWebsitePageRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
