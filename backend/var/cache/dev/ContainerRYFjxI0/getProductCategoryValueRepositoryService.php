 ...
 */
class getProductCategoryValueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProductCategoryValueRepository' shared autowired service.
     *
     * @return \App\Repository\ProductCategoryValueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProductCategoryValueRepository.php';

        return $container->privates['App\\Repository\\ProductCategoryValueRepository'] = new \App\Repository\ProductCategoryValueRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
