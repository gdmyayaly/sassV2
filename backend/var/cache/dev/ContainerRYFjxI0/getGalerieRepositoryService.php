 ...
 */
class getGalerieRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GalerieRepository.php';

        return $container->privates['App\\Repository\\GalerieRepository'] = new \App\Repository\GalerieRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
