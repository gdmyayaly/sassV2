 ...
 */
class getWebsitePageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\WebsitePageRepository' shared autowired service.
     *
     * @return \App\Repository\WebsitePageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'WebsitePageRepository.php';

        return $container->privates['App\\Repository\\WebsitePageRepository'] = new \App\Repository\WebsitePageRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
