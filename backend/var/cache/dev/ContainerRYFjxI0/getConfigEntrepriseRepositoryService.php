 ...
 */
class getConfigEntrepriseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ConfigEntrepriseRepository' shared autowired service.
     *
     * @return \App\Repository\ConfigEntrepriseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ConfigEntrepriseRepository.php';

        return $container->privates['App\\Repository\\ConfigEntrepriseRepository'] = new \App\Repository\ConfigEntrepriseRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
