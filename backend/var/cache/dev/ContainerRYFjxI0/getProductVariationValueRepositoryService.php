 ...
 */
class getProductVariationValueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProductVariationValueRepository' shared autowired service.
     *
     * @return \App\Repository\ProductVariationValueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProductVariationValueRepository.php';

        return $container->privates['App\\Repository\\ProductVariationValueRepository'] = new \App\Repository\ProductVariationValueRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
