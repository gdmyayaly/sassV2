 ...
 */
class getVariationProductRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VariationProductRepository' shared autowired service.
     *
     * @return \App\Repository\VariationProductRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VariationProductRepository.php';

        return $container->privates['App\\Repository\\VariationProductRepository'] = new \App\Repository\VariationProductRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
