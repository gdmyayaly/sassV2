 ...
 */
class getClientSectionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ClientSectionRepository' shared autowired service.
     *
     * @return \App\Repository\ClientSectionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClientSectionRepository.php';

        return $container->privates['App\\Repository\\ClientSectionRepository'] = new \App\Repository\ClientSectionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
