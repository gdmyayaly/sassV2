 ...
 */
class getSousCategoryProductRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SousCategoryProductRepository' shared autowired service.
     *
     * @return \App\Repository\SousCategoryProductRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SousCategoryProductRepository.php';

        return $container->privates['App\\Repository\\SousCategoryProductRepository'] = new \App\Repository\SousCategoryProductRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
