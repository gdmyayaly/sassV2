 ...
 */
class getSocialMediaLinkRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SocialMediaLinkRepository' shared autowired service.
     *
     * @return \App\Repository\SocialMediaLinkRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SocialMediaLinkRepository.php';

        return $container->privates['App\\Repository\\SocialMediaLinkRepository'] = new \App\Repository\SocialMediaLinkRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
