...
// function isMobile() {
// 	return /(iphone|android|blackberry|webos|palm|symbian)/i.test(navigator.userAgent);
// }
  
//   // Charge le fichier CSS si l'appareil est un téléphone
// if (isMobile()) {
// 	var link = document.createElement('link');
// 	link.href = 'css/index_mob.css';
// 	link.rel = 'stylesheet';
